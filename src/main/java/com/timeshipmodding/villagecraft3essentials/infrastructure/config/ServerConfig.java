...
public class ServerConfig {
    ...
    public static ModConfigSpec.BooleanValue PLAYER_DISPLAY_NAME_FORMATTING;
    ...
    static {
        ...
        BUILDER.pop();
        BUILDER.push("Player Display Name Formatting");
        BUILDER.comment("Formats all player's names depending on luckperms configurations");

        PLAYER_DISPLAY_NAME_FORMATTING = BUILDER
                .define("enablePlayerDisplayNameFormatting", true);
