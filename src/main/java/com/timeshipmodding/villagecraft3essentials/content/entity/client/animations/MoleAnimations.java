package com.timeshipmodding.villagecraft3essentials.content.entity.client.animations;
...
public class MoleAnimations {
	public static final AnimationDefinition ANIMATION_MOLE_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
			...
			.addAnimation("nose", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 1.5F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
			))
			.build();
}