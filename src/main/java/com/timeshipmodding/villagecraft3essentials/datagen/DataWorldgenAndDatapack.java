...
import com.timeshipmodding.villagecraft3essentials.content.worldgen.biomemodifiers.ModOreBiomesModifiers;
...
public class DataWorldgenAndDatapack extends DatapackBuiltinEntriesProvider {
    public static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
            ...
            .add(NeoForgeRegistries.Keys.BIOME_MODIFIERS, ModOreBiomesModifiers::bootstrap);
